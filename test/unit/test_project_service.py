...
async def test_find_projects(mock_session, mock_repository, project_service):
    # given
    name_like = "a"
    ...
    mock_repository.find_all.return_value = [project1, project2]
...
async def test_get_project(mock_session, mock_repository, project_service):
    # given
    project_id = 1
    domain_id = 1
...
async def test_get_project_fail_not_found(mock_session, mock_repository, project_service):
    # given
    project_id = 999
